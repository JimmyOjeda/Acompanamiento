...
int main()
{
	...
	while (optionPerson!=6){
		...
		printf("1. %s  --- %d actividades\n",listPersons[0]->name,listPersons[0]->list->index);
		printf("2. %s --- %d actividades\n",listPersons[1]->name,listPersons[1]->list->index);
		printf("3. %s  --- %d actividades\n",listPersons[2]->name,listPersons[2]->list->index);
		printf("4. %s  --- %d actividades\n",listPersons[3]->name,listPersons[3]->list->index);
		printf("5. %s --- %d actividades\n",listPersons[4]->name,listPersons[4]->list->index);
		printf("6. Para Salir \n");
		scanf("%d",&optionPerson);
		system("cls");
		
		int option=0;
		while (optionPerson!=6 && option!=6 && (optionPerson==1 || optionPerson==2 || optionPerson==3 || optionPerson==4 || 
																										optionPerson==5)){
